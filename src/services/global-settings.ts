...
> = {
  ...
  next_payment_run_date: {
    value: '',
    description:
      'Next scheduled payment run date (YYYY-MM-DD). Included in automated responses to suppliers.',
  },
  require_approval_above: {
    value: '1000',
    description:
      'Require manual approval for responses whose variance exceeds this amount.',
  },
  test_mode_enabled: {
    value: 'false',
    description:
      'When true, all outbound supplier emails are redirected to the test address below.',
  },
  test_mode_email: {
    value: '',
    description:
      'All supplier emails are sent here instead of the real contact when test mode is on.',
  },
  response_cc_email: {
    value: '',
  ...
  require_sender_approval: {
    value: 'true',
    description:
      'New sender email addresses require operator approval before statements are processed.',
  },
...
<p>Regards,<br>{company_sign_off}</p>`,
    description:
      'Email body template when balances agree. Supports merge fields ({contact_name}, {supplier_name}, {statement_date}, {their_balance}, {payment_schedule}, {company_sign_off}).',
  },
...
<p>Regards,<br>{company_sign_off}</p>`,
    description:
      'Email body template when there are queries. Supports the same merge fields plus {query_count} and {query_table} (auto-inserted list).',
  },
  response_sign_off: {
